...
class Response(TimeStampedModel):
    ...
    user = models.ForeignKey(Article, on_delete=models.CASCADE, related_name="responses")
    ...
    def __str__(self):
        return f"{self.user.first_name} commented on {self.article.title}" # type: ignore   
