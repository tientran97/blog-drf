...
schema_view = get_schema_view(
    openapi.Info(
        ...
        contact=openapi.Contact(email="tien.minhtran615034@gmail.com "),
...
urlpatterns = [
    ...
    path("api/v1/auth/user/", include("core_apps.profiles.urls")),
...
admin.site.index_title = "Welcome to API Admin Portal"
